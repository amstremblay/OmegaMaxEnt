...
2) To install from Source, Download and extract the source files: OmegaMaxEnt_source_2017-08.zip

3) Download armadillo-5.600.2.tar.gz in this download directory and extract it in the OmegaMaxEnt source code directory. Note: There are more recent versions of [http://arma.sourceforge.net armadillo], but it is recommended to use the version provided to avoid any incompatibility between versions.

4) Copy the makefile from the directory corresponding to your system (Mac or Linux) to the source code directory and execute the command "make".
